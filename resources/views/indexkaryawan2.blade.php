...
@section('content')
    ...
    @endif
    <h2>Data Karyawan</h2>
    <a href="/karyawan2/tambah2" class="btn btn-primary mt-3 mb-4" style="border-radius: 10px"> + Tambah karyawan Baru</a>
    <br>
    ...
    <table border="1" class="table table-striped">
        ...
        @foreach ($karyawan as $p)
            <tr>
                ...
                <td>
                    <a href="/karyawan2/hapus2/{{ $p->kodepegawai }}" class="btn btn-danger"
