    ...
    <div class="topbar d-flex align-items-center dark-background">
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="contact-info d-flex align-items-center">
          <i class="bi bi-envelope d-flex align-items-center"><a href="https://github.com/zakyalkhair">github.com/zakyalkhair</a></i>
          <i class="bi bi-phone d-flex align-items-center ms-4"><span>Muhammad Zaky Al Khair</span></i>
        </div>
      </div>
    </div>
    <div class="branding d-flex align-items-cente">
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center">
          ...
          <h1 class="sitename">Pemrograman Web</h1>
        </a>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <a href="materi3" class="stretched-link">
                <h3>Materi 3: Grid and Layout</h3>
              </a>
            </div>
          </div>
